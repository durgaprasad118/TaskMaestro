            ...
            {open && (
                ...
                >
                    ...
                    <motion.div
                        ref={modalRef}
                        className={cn(
                            'h-[72%] md:max-w-[40%] bg-white dark:bg-slate-950 border border-transparent dark:border-slate-800 md:rounded-2xl relative z-50 flex flex-col flex-1 overflow-hidden',
                            className
                        )}
